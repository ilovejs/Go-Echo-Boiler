...
//TODO: couple with store !!
func newProfileResponse(us glue.UserStoreInterface,
	userID uint,
	u *model.User) *profileResponse {
...
//TODO: coupled with store
func newArticleListResponse(us glue.UserStoreInterface,
	userID uint, articles []model.Article, count int) *articleListResponse {
